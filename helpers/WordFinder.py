...
class WordFinder:
    ...
    async def check_keleo(self, bot, message):
        ...
        responses = ["https://media.discordapp.net/attachments/727476894106386504/1117027462015107164/keleo_gif.gif", "You only need 3 things in life, happiness and good weather - the golden rule by keleo"]
